...
FilterComponent::FilterComponent(juce::AudioProcessorValueTreeState& apvts, juce::String filterID) : filterID(filterID)
{
    ...
    highCutAttachment = std::make_unique<SliderAttachment>(apvts, getStringParameter("Decay"), highCutFreqSlider);
    peakFreqAttachment = std::make_unique<SliderAttachment>(apvts, getStringParameter("Sustain"), peakFreqSlider);
    peakGainInDecibelsAttachment = std::make_unique<SliderAttachment>(apvts, getStringParameter("Release"), peakGainInDecibelsSlider);
    peakQualityAttachment = std::make_unique<SliderAttachment>(apvts, getStringParameter("Decay"), peakQualitySlider);
